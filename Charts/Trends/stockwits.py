...
file_path = r"C:\Users\PraveenChaudhary\OneDrive - Prowess\Dipesh Solanki's files - Brand Pluse\data\LRCX_stocktwits_sentiment.xlsx"
...
if 'Date' not in df.columns:
    raise ValueError(f"Expected column 'Date', found: {df.columns.tolist()}")
...
# Final layout
fig.update_layout(
    title="Stockwits Sentiment Distribution (Monthly Line Chart)",
